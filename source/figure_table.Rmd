...
#### SFig5.1: Similar to Fig 3 but using parameters that resemble values from high incidence settings

```{r SFig5.1, fig.height=3.2, fig.width=9}
...
#### SFig 5.2: Test the enhanced vaccine immunogenicity hypothesis
